...
{
       0,   172,   172,   189,   206,   221,   234,   248,   261,   270,
     299,   326,   353,   353,   372,   372,   392,   392,   413,   438,
     461,   480,   503,   524,   543,   562,   586,   606,   621,   635,
     651,   669,   692,   706,   725,   739,   754,   769,   783,   797,
     817,   835,   857,   877,   899,   918,   932,   947,   964,   992,
    1029,  1044,  1075,  1092,  1111,  1127,  1152,  1168,  1189,  1206,
    1235,  1256,  1277,  1295,  1311,  1362,  1380,  1396,  1411,  1433,
    1456,  1472,  1488,  1496,  1513,  1530
};
#endif
...
#line 1044 "1905021.y"
		...
		else if((yyvsp[-2].SymbolInfo)->getTypeSpecifier() != (yyvsp[0].SymbolInfo)->getTypeSpecifier() and (yyvsp[-2].SymbolInfo)->getTypeSpecifier() != "error" and (yyvsp[0].SymbolInfo)->getTypeSpecifier() != "error"){
